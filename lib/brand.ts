...
export const brand: Brand = {
  name: "Susan Chanel Beauty",
  shortName: "Susan Chanel",
  microTag: "YOUR ONE-STOP SHOP FOR BEAUTIFUL",
  description:
    "Susan Chanel Beauty is a Accra beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0594770655",
    phoneTel: "+233594770655",
    textPhone: "0594770655",
    textPhoneTel: "+233594770655",
    email: "hello@susanchanel.test",
    privacyEmail: "privacy@susanchanel.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@susanchanelbeauty", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "everything beautiful,\none address.\nYour one-stop shop for beautiful.",
    subtitle:
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "At Susan Chanel Beauty, self-care is not a someday luxury. It is an hour that fits into your actual life and pays you back all week.",
    ...
    images: [
      {
        ...
        alt: "Susan Chanel Beauty beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Susan Chanel Beauty self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Susan Chanel Beauty beauty ritual",
      ...
      },
      {
        ...
        alt: "Susan Chanel Beauty calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Susan Chanel Beauty relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Susan Chanel Beauty beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Susan Chanel Beauty lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Susan Chanel Beauty mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Susan Chanel Beauty makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Susan Chanel Beauty foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@susanchanelbeauty",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783492589/stage4/spa_susanchanelbeauty/tiktok_0.mp4",
        alt: "Susan Chanel Beauty treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581425/w22e5ae19sjiofurtmlm.mp4",
        alt: "Susan Chanel Beauty beauty media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581429/hptukehgmrufp33qyd5e.mp4",
        alt: "Susan Chanel Beauty salon media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Susan Chanel Beauty self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Susan Chanel Beauty studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Susan Chanel Beauty",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Susan Chanel Beauty is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0594770655 and text 0594770655 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0594770655, text 0594770655, or message @susanchanelbeauty on Instagram." },
          ...
          { q: "Where are you located?", a: "Susan Chanel Beauty is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@susanchanel.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Susan Chanel Beauty (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@susanchanel.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Susan Chanel Beauty is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@susanchanel.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Susan Chanel Beauty",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0594770655", href: "tel:+233594770655" },
      { label: "Text", value: "0594770655", href: "sms:+233594770655" },
      { label: "Instagram", value: "@susanchanelbeauty", href: "https://www.tiktok.com/@susanchanelbeauty" },
    ],
  },
  ...
  footer: {
    blurb:
      "Susan Chanel Beauty in Accra — your one-stop shop for beautiful.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@susanchanelbeauty" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0594770655", href: "tel:+233594770655" },
          { label: "Text 0594770655", href: "sms:+233594770655" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Susan Chanel Beauty — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },

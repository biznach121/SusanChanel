...
export function QualityProducts({
  ...
  return (
    <section ref={sectionRef} className="relative isolate overflow-hidden bg-[#f3e1dc] px-4 pb-20 pt-12 text-[#461d3a] sm:px-8 lg:pb-28">
      <QualityVines />
      <div className="relative z-10 mx-auto max-w-[1180px]">
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          ...
          />
          <span className="text-[13px] font-semibold text-[#461d3a]/70">
...
function ProductCard({
  ...
  return (
    <article
      ...
      className={[
        "relative min-h-[560px] cursor-pointer overflow-hidden rounded-[180px] border border-white/25 px-7 pb-8 pt-[82px] shadow-[0_24px_70px_rgba(70, 29, 58,0.08)] transition-transform hover:-translate-y-1 sm:h-[660px] sm:rounded-[240px] sm:px-12 sm:pt-[104px] lg:h-[720px] lg:px-14 lg:pt-[112px]",
        position === 0 ? "lg:translate-y-[-16px]" : "hidden lg:block lg:translate-y-[24px]",
        isOlive ? "bg-[#9f695d] text-white" : "bg-[#ebcbc3] text-[#461d3a]",
      ].join(" ")}
    >
      <div
        className={[
          "pointer-events-none absolute inset-3 rounded-[inherit] border",
          isOlive ? "border-white/16" : "border-[#461d3a]/10",
        ].join(" ")}
      />
      <div className="relative z-10 grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4">
        ...
        <button
          ...
          className={[
            ...
            isOlive ? "bg-[#f8ebe7] text-[#8b584b]" : "bg-[#461d3a] text-white",
          ].join(" ")}
        >
      ...
      <div
        className={[
          "absolute inset-x-0 bottom-7 mx-auto h-[235px] w-[84%] overflow-hidden rounded-[999px] shadow-[0_18px_44px_rgba(70, 29, 58,0.18)] sm:bottom-9 sm:h-[300px] sm:w-[80%] lg:h-[330px]",
          isOlive ? "bg-[#8b584b]" : "bg-[#e0b2a6]",
        ].join(" ")}
      >
        {image ? (
          <Image
...
function CarouselButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      aria-label={label}
      className="grid h-12 w-12 place-items-center rounded-full border border-[#461d3a]/35 text-[#461d3a] transition-colors hover:bg-[#461d3a] hover:text-[#f3e1dc] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-transparent disabled:hover:text-[#461d3a]"
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"

...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783492585/stage4/spa_susanchanelbeauty/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Susan Chanel Beauty - Your one-stop shop for beautiful">
        <Image
          src={src}
          alt="Susan Chanel Beauty - Your one-stop shop for beautiful"
          fill

...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#742040] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#81264c]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(75, 15, 40,0.58),rgba(101, 9, 57,0.22)_43%,rgba(77, 20, 42,0.34)),linear-gradient(0deg,rgba(40, 12, 22,0.18),rgba(40, 12, 22,0.08))]" />
